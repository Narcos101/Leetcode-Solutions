<h2>2357. Make Array Zero by Subtracting Equal Amounts</h2><h3>Easy</h3><hr><div><p>You are given a non-negative integer array <code>nums</code>. In one operation, you must:</p>
