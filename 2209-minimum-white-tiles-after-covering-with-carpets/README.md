<h2>2209. Minimum White Tiles After Covering With Carpets</h2><h3>Hard</h3><hr><div><p>You are given a <strong>0-indexed binary</strong> string <code>floor</code>, which represents the colors of tiles on a floor:</p>
