<h2>2415. Reverse Odd Levels of Binary Tree</h2><h3>Medium</h3><hr><div><p>Given the <code>root</code> of a <strong>perfect</strong> binary tree, reverse the node values at each <strong>odd</strong> level of the tree.</p>
